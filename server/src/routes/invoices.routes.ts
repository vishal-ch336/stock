...
router.post('/parse', uploadHandler, async (req: Request, res: Response) => {
...
router.post('/ingest', validate(z.object({ body: ingestInvoiceDTOSchema })), async (req: Request, res: Response) => {
